      ...
      <div className="flex flex-grow items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="text-center pt-10 pb-6">
            ...
            <h1 className="mt-4 text-2xl font-bold text-gray-800">Join MovieFind</h1>
            <p className="mt-2 text-sm text-gray-600">Create an account to start exploring movies</p>
          </div>
